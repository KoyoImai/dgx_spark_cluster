...
- モデル：Qwen3-235B-A22B Q2_K（79.80 GiB）
- pp8192：8192トークンのプロンプト処理速度（t/s）
- tg8192：8192トークンの生成速度（t/s）
- 測定回数：3回の平均（`-r 3`）

### 結果一覧4
| パターン | node数 | NW | backend | pp8192 (t/s) | tg8192 (t/s) |
|---|---:|---|---|---:|---:|
| 1台 | 1 | - | CUDA |  |  |
| 2台（QSFP） pair1 | 2 | QSFP 200Gbps | CUDA,RPC | 189.18 ± 0.63 | 13.99 ± 0.01 |
| 2台（QSFP） pair2 | 2 | QSFP 200Gbps | CUDA,RPC |  |  |
| 2台（RJ45） | 2 | RJ45 1Gbps | CUDA,RPC | 168.99 ± 0.07| 14.02 ± 0.01 |
| 4台（RJ45） | 4 | RJ45 1Gbps | CUDA,RPC | - | - |
| 2台（RJ45） | 2 | RJ45 10Gbps | CUDA,RPC | - | - |
| 4台（RJ45） | 4 | RJ45 10Gbps | CUDA,RPC | - | - |
